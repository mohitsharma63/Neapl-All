          ...
          <Card>
            <CardHeader className="text-center">
              ...
              <p className="text-muted-foreground">
                आफ्नो खातामा प्रवेश गर्नुहोस् | Sign in to your account
              </p>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                >
                  {isLoading ? "लगइन गर्दै... | Signing in..." : "लगइन | Sign In"}
                </Button>
              </form>
              ...
              <div className="mt-6">
                ...
                <div className="mt-6 space-y-3">
                  <Button variant="outline" className="w-full" data-testid="button-google-login">
                    ...
                    Google सँग लगइन | Continue with Google
                  </Button>
                  ...
                  <Button variant="outline" className="w-full" data-testid="button-facebook-login">
                    ...
                    Facebook सँग लगइन | Continue with Facebook
                  </Button>
                </div>
              </div>
