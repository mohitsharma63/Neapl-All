...
export const languageClasses = pgTable("language_classes", {
  ...
  nativeSpeaker: boolean("native_speaker").default(false),
  feePerMonth: decimal("fee_per_month", { precision: 10, scale: 2 }).notNull(),
  registrationFee: decimal("registration_fee", { precision: 10, scale: 2 }),
  totalCourseFee: decimal("total_course_fee", { precision: 10, scale: 2 }),
  studyMaterialsProvided: jsonb("study_materials_provided").$type<string[]>().default([]),
  certificationProvided: boolean("certification_provided").default(false),
  freeDemoClass: boolean("free_demo_class").default(false),
  contactPerson: text("contact_person").notNull(),
  contactPhone: text("contact_phone").notNull(),
  contactEmail: text("contact_email"),
  country: text("country").notNull().default("India"),
